...
data_path = "/Users/krishna/Downloads/IEMOCAP_full_release/"
...
def read_iemocap_mocap(sessions):
    data = []
    ids = {}
...
data2 = read_iemocap_mocap(sessions)

import pickle
with open('data_collected_full.pickle', 'wb') as handle:
